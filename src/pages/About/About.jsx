        ...
        <div className="py-10 px-3">
            <div className="container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 items-center">
                    <div>
                        <h2 className="text-2xl font-titleText">Our Mission</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-titleText mt-3 ">Who We Are</h2>
                        <p>
                ...
                <div>
                    <h2  className="text-2xl font-titleText">Our Commitment</h2>
                    <p>
